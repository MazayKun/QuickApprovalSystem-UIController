    ...
    $.extend(Plugin.prototype, {
        ...
        create: function () {
            ...
            for (var k = 0; k < this.settings.days; k++) {
                $('<div class="jqs-grid-day">' + this.settings.daysList[k] + dayRemove + dayDuplicate + '</div>').appendTo($('.jqs-grid-head', this.element));
            }
        },
        ...
        add: function (parent, position, height, options) {
            ...
            var period = $('<div class="jqs-period">' +
                ...
                .attr('schedule-id', options.id).attr('active', options.active)  // edit by Pavel Khobotov
                .appendTo(parent);
        ...
        duplicate: function (period) {
            if (!this.settings.onDuplicatePeriod.call(this, period, this.element)) {
                ...
                options.id = undefined; // edit by Pavel Khobotov
                options.active = 'false'; // edit by Pavel Khobotov
        ...
        periodData: function (period) {
            ...
            return {
                id: period.attr('schedule-id'), // edit by Pavel Khobotov
                active: period.attr('active'), // edit by Pavel Khobotov
